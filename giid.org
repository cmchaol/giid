...
#+RESULTS:
-rw-r--r-- 1 c5766 c5766 589 Sep  1 16:35 build.sh
-rwxr-xr-x 1 c5766 c5766 589 Sep  1 16:35 build.sh
...
# /dev/sdd5: UUID="2d913413-05a1-4959-a715-8b873f463037"
theuuid="2d913413-05a1-4959-a715-8b873f463037"
...
echo $(findfs UUID=$theuuid) \# print 1

echo $(findfs UUID=\$theuuid) \# print 2

echo \$(findfs UUID=$theuuid) \# print 3
...
rescue_shell   # everything below will not show
...
ALSA device list:
  #0: Dummy 1
Freeing unused kernel memory: 2672K (ffffffff82600000 - ffffffff8289c000)
...
CPU: 0 PID: 1 Comm: init Not tainted 4.8.17-hardened-r2-openstack #1
Hardware name: QEMU Standard PC (i440FX + PIIX, 1996), BIOS rel-1.10.1-0-g8891697-prebuilt.qemu-project.org 04/01/2014
 0000000000000086 0000000000000086 ffffc9000004bd70 ffffffff81613809
 0000000000000001 ffff88000709b300 ffffffff82032ce2 ffffc9000004bdf8
 ffffffff811d9e74 ffff880000000010 ffffc9000004be08 ffffc9000004bd98
Call Trace:
 [<ffffffff81613809>] dump_stack+0x58/0x83
 [<ffffffff811d9e74>] panic+0xd0/0x253
 [<ffffffff8113aa3a>] do_exit+0x4d2/0x933
 [<ffffffff8113bb81>] do_group_exit+0x45/0xb1
 [<ffffffff8113bbff>] sys_exit_group+0x12/0x1a
 [<ffffffff8100158c>] do_syscall_64+0x9d/0x14f
 [<ffffffff81cd7823>] entry_SYSCALL64_slow_path+0x25/0x25
